<?php
// =============================== My Sidebar Recent Posts (News widget) ======================================
class MY_SidebarPostWidget extends WP_Widget {
    /** constructor */
    function MY_SidebarPostWidget() {
        parent::WP_Widget(false, $name = 'My - Sidebar Recent Posts');	
    }
						...
						<?php  $temp = $wp_query;
								...
								<li class="clearfix">
									...
									<div class="extra-wrap">
										...
										<?php } ?>
										<time datetime="<?php the_time('Y-m-d\TH:i'); ?>"><?php the_time('d F, Y'); ?></time>
